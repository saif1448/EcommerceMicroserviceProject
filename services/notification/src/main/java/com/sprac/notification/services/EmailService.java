package com.sprac.notification.services;


import com.sprac.notification.kafka.order.Product;
import com.sprac.notification.kafka.payment.PaymentConfirmation;
import com.sprac.notification.models.enums.EmailTemplates;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(String destinationEmail,
        ...
        messageHelper.setFrom("saif.mahmud.parvez@gmail.com");
        ...
        try {
            ...
            logger.info(String.format("Email Successfully sent to %s with template %s,", destinationEmail, templateName));

        } catch (MessagingException e) {
            logger.warn("Cannot email to {}", destinationEmail);
        }
